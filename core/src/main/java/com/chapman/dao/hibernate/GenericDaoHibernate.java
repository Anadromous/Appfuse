 ...
 * <pre>
 *      &lt;bean id="fooDao" class="com.chapman.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="com.chapman.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    public Session getSession() throws HibernateException {
    	log.debug("Getting the session..............................");
        Session sess = getSessionFactory().getCurrentSession();
        log.debug("got the session from GenericDaoHibernate.........");
        if (sess == null) {
        	log.debug("Session was null, calling openSession().........");
